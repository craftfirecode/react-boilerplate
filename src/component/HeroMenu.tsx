...
const HeroMenu = () => {
    return (
        <div className="bg-indigo-300 shadow-lg">
            <div className="flex">
                <div className="ms-0">
                    Logo
                </div>
                <div className="ms-auto">
                    <NavigationMenu.Root className="relative z-[1] flex justify-center" orientation="vertical">
                        <NavigationMenu.List className="center m-0 flex list-none p-1">
                            <NavigationMenu.Item>
                                ...
                                <NavigationMenu.Content className="border border-blue-600">
                                    <ul className="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
                                        <li className="row-span-3 grid">
                                            <NavigationMenu.Link asChild>
                                                <a
                                                    className="focus:shadow-violet7 from-pink-400 to-indigo-300 flex
